...
function EsLoader(conf, jmsClient) {
    ...
    var createJSON = function(ESClient, json, message) {
        ...
        if (batch > 0) {
            ...
            console.log("create");
            ESClient.index(json, function(error, response) {
    ...
    var deleteJSON = function(ESClient, json, message) {
        ...
        if (batch > 0) {
            ...
            console.log("delete");
            ESClient.delete(json, function(error, response) {
    ...
    var updateByQueryJSON = function(ESClient, json, message) {
        ...
        */
        ...
        ESClient.updateByQuery(json, function(error, response) {
            if (error) {
                message.nack();
                console.log(error);
                return;
